...
const { title: book2Title, author: book2Author, libraryID: libraryID2 } = book2;

console.log(`The title of the book is ${book2Title}, the author is ${book2Author}, and the library id is ${libraryID2}`);
